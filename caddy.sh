...
Download_caddy(){
	...
	if [[ ${bit} == "x86_64" ]]; then
		wget --no-check-certificate -O "caddy_linux.tar.gz" "https://caddyserver.com/api/download?os=linux&arch=arm64&p=github.com%2Fabiosoft%2Fcaddy-hmac&idempotency=52873762862622"
